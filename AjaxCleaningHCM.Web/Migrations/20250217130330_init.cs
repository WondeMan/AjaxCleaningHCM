        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactPersonId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuBuilders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyContactFullName = table.Column<string>(nullable: false),
                    ...
                    MaximumCredit = table.Column<decimal>(nullable: false),
                    NumberOfVacation = table.Column<int>(nullable: false),
                    ...
                    WeeklyPay = table.Column<decimal>(nullable: false),
                    MonthlySalary = table.Column<decimal>(nullable: false),
                    BankAccountNumber = table.Column<string>(nullable: true),
                    BankId = table.Column<long>(nullable: true),
                    DepartmentId = table.Column<long>(nullable: true),
                    EmploymentLetterPath = table.Column<string>(nullable: true),
                    EmpoloyePhotoPath = table.Column<string>(nullable: true),
                    EmployeeKebeleIDPath = table.Column<string>(nullable: true),
                    GurrentKebeleIDPath = table.Column<string>(nullable: true),
                    GurrentDocumentPath = table.Column<string>(nullable: true),
                    CirtificationPath = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
